...
rm $domain2  -Rf
./minica --domains 'app.local'
cp ./$domain2/cert.pem ./$domain2/app.local.crt
cp ./$domain2/cert.pem ../etc/nginx/conf.d/certs/

cp ./$domain2/key.pem ./$domain2/app.local.key
cp ./$domain2/key.pem ../etc/nginx/conf.d/certs/
chmod 755 ./$domain2
