...
?>
	<footer id="colophon" class="site-footer" itemscope itemtype="https://schema.org/WPFooter">
        ...
        $starter_shop_newsletter =  best_shop_get_setting('subscription_shortcode');
        
        if( $active_sidebars && $sidebar_count > 0 ||  $starter_shop_newsletter !=='' ){ ?>
            <div class="footer-top">
                <div class="container"><?php

                    if($starter_shop_newsletter) {
                        ?>
                        <div class="footer-newsletter-section">
                        <?php
                        the_widget('best_shop_newsletter_widget', array('newsletter_shortcode'=> $starter_shop_newsletter ));
                        ?>
                        </div>
                        <?php
